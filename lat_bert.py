...
class LatinBERT:
    ...
    def get_berts(self, raw_sents):
        ...
        batch_size = 32
        batched_data, batched_mask, batched_transforms, ordering = self.get_batches(
            sents, batch_size, self.wp_tokenizer
        )
...
class BertLatin(nn.Module):
    ...
    def forward(
        self, input_ids, token_type_ids=None, attention_mask=None, transforms=None
    ):
        ...
        all_layers = bert_out.last_hidden_state
